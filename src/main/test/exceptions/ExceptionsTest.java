...
class ExceptionsTest {
    ...
    void ArrayIsNotSortedExceptionTest() {
        ...
        assertThrows(ArrayIsNotSortedException.class, () -> {
            TabulatedFunction func = new ArrayTabulatedFunction(arrayOfX, arrayOfY);
        });
    }
    ...
    void DifferentLengthOfArraysExceptionTest() {
        ...
        assertThrows(DifferentLengthOfArraysException.class, () -> {
            TabulatedFunction func = new ArrayTabulatedFunction(arrayOfX, arrayOfY1);
        });
    }
    ...
    void InterpolationExceptionTest() {
        ...
        assertThrows(InterpolationException.class, () -> {
            throw new InterpolationException("Incorrect index");
        });
    }
}